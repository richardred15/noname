 ...
 *   combination with the trigonometric functions Math.sin() 
 *   and cos().
 *
 */
 ...
 */
declare function Math.floor(n: number): number;
...
/**
 *   The inverse of Math.sin(), returns the arc sine of a 
 *   value. This function expects the values in the 
 *   range of -1 to 1 and values are returned in the 
 *   range -PI/2 to PI/2.
 *
 ...
 */
declare function aMath.sin(value: number): number;
 ...
 */
declare function Math.sin(angle: number): number;
